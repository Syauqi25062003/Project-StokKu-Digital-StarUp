...
if(isset($_POST['addproduk'])){
	...
	//hitung stock sekarang anda berapa
...
if(isset($_POST['hapusprodukpesanan'])){
	...
	$update = mysqli_query($c,"delete from detailpesanan where idproduk='$idpr' and iddetailpesanan='$idp'");
...
// 		//cari tau stock sekarang berapa
		...
		//$query_update = mysqli_query($c,"update produk set stock='$newstock' where idproduk='$idproduk'")



		//hapus data
		 $querydelete = mysqli_query($c,"delete from detailpesanan where iddetailpesanan='$idp'");
...
// //mengubah data detail pesanan
 // if(isset($_POST['editdetailpesanan'])){
	// $qty = $_POST['qty'];
	// $idm = $_POST['iddp']; //id masuk
	// $idp = $_POST['idpr']; //id produk
